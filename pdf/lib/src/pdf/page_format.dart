...
class PdfPageFormat {
  ...
  static const PdfPageFormat a6 = PdfPageFormat(
    105 * mm,
    148 * mm,
    marginAll: 1.0 * cm,
  );
  ...
  static const PdfPageFormat roll57 = PdfPageFormat(
    57 * mm,
    double.infinity,
    marginAll: 5 * mm,
  );
  ...
  static const PdfPageFormat roll104 = PdfPageFormat(
    4 * inch,
    double.infinity,
    marginAll: 5 * mm,
  );

  static const PdfPageFormat undefined = PdfPageFormat(
    double.infinity,
    double.infinity,
  );
